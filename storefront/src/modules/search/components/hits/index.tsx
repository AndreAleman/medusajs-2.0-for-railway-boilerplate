...
type HitsProps<THit> = React.ComponentProps<"div"> &
  UseHitsProps & {
    hitComponent: (props: { hit: THit; searchQuery?: string }) => JSX.Element  // ✅ ADD searchQuery
  }
      ...
      {hits.length > 0 && (
        ...
        >
          {hits.slice(0, 6).map((hit, index) => (
            ...
            >
              {/* ✅ PASS query to Hit component */}
              <Hit hit={hit as unknown as ProductHit} searchQuery={query} />
            </li>
          ))}
        </div>
      )}
