...
import { SanityClient, createClient, FirstDocumentMutationOptions } from "@sanity/client"

const SyncDocumentTypes = { PRODUCT: "product" } as const
...
class SanityModuleService {
  ...
  constructor({ logger }: InjectedDependencies, options: ModuleOptions) {
    ...
    // TODO: initialize more properties if needed
  }
